...
namespace EmbyStat.Repositories
{
    public class ShowRepository : IShowRepository
    {
        ...
        public int GetEpisodeCountForShow(int showId, bool includeMissing)
        {
            return GetEpisodeCountForShow(showId, false, includeMissing);
        }

        public int GetEpisodeCountForShow(int showId, bool includeSpecials, bool includeMissing)
        {
            var show = _showCollection.FindById(showId);

            if (!includeSpecials && !includeMissing)
            {

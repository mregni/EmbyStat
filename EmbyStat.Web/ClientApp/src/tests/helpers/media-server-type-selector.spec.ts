...
describe('MediaServerTypeSelector', () => {
  ...
  describe('when getServerApiPage is called with 0', () => {
    it('should return Jellyfin', () => {
      const helper = MediaServerTypeSelector.getServerApiPage(0);
      expect(helper).toEqual('apikeys');
    });
  });

  describe('when getServerApiPage is called with 1', () => {
    it('should return Emby', () => {
      const helper = MediaServerTypeSelector.getServerApiPage(1);
      expect(helper).toEqual('apikeys.html');
    });
  });
});

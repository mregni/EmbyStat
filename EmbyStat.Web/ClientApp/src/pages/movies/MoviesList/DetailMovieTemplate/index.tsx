  ...
  return (
    movie.id != null ?
      <div className={classes.container}>
        <Grid container className="p-16">
          ...
          <Grid item container direction="column" xs spacing={1} justify="flex-start">
            ...
            <Grid item container alignItems="center">
              <StorageRoundedIcon />
              <p className="m-l-8">{calculateFileSize(movie.mediaSources[0].sizeInMb)}</p>
            </Grid>
            <Grid item container alignItems="center">
              <QueryBuilderRoundedIcon />
              <p className="m-l-8">{calculateRunTime(movie.mediaSources[0].runTimeTicks)}</p>
            </Grid>
            <Grid item container alignItems="center">
            ...
            <Grid item container alignItems="center">
              ...
              <Grid item container xs>
                ...
                {
                  movie.subtitleStreams
                    .some(x => x.language == null || x.language === 'src') ?
        ...
        <Grid container justify="flex-end" spacing={2} className={classes.movie__links}>
          <Grid item>
            <Button
              variant="outlined"
              color="secondary"

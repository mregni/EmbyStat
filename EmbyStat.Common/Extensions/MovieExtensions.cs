...
public static class MovieExtensions
{
    ...
    public static string GenerateFullMovieQuery(IEnumerable<Filter> filters,string sortField, string sortOrder)
    {
        var query = $@"
...
WHERE 1=1 ";
    ...
    public static string GenerateCountQuery(IEnumerable<Filter> filters)
    {
        var query = $@"

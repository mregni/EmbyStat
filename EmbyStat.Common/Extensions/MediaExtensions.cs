...
public static class MediaExtensions
{
    ...
    public static string GenerateGetPremieredListQuery(int count, string orderDirection, string table)
    {
        return $@"SELECT s.*
FROM {table} AS s
...
LIMIT {count}";
    ...
    public static string GenerateGetCommunityRatingListQuery(int count, string orderDirection, string table)
    {
        return $@"SELECT s.*
FROM {table} AS s

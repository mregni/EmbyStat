...
namespace EmbyStat.Common.Extensions
{
    public static class SqlMediaExtensions
    {
        ...
        public static string GenerateGetPremieredListQuery<T>(this DbSet<T> list, int count, string orderDirection, string table) where T : SqlExtra
        {
            return $@"SELECT s.*
FROM {table} AS s
...
LIMIT {count}";
        ...
        public static IEnumerable<T> GetLatestAddedMedia<T>(this DbSet<T> list, int count) where T : SqlMedia
        {
            return list
        ...
        public static string GenerateGetCommunityRatingListQuery<T>(this DbSet<T> list, int count, string orderDirection, string table) where T : SqlExtra
        {
            return $@"SELECT s.*
FROM {table} AS s

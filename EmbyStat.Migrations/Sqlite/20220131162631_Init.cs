        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalSyncFailed = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowId = table.Column<string>(type: "TEXT", nullable: true),
                    SeasonIndexNumber = table.Column<int>(type: "INTEGER", nullable: true),
                    LocationType = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SqlShowPerson", x => new { x.ShowId, x.PersonId, x.Type });
                    table.ForeignKey(
                        name: "FK_SqlShowPerson_Episodes_SqlEpisodeId",
                        column: x => x.SqlEpisodeId,
                        principalTable: "Episodes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SqlShowPerson_People_PersonId",
                        column: x => x.PersonId,
                        principalTable: "People",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SqlShowPerson_Shows_ShowId",
                        column: x => x.ShowId,
                        principalTable: "Shows",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SqlShowPerson_PersonId",
                table: "SqlShowSqlPerson",
                column: "PersonId");

            migrationBuilder.CreateIndex(
                name: "IX_SqlShowPerson_SqlEpisodeId",
                table: "SqlShowSqlPerson",
                column: "SqlEpisodeId");
